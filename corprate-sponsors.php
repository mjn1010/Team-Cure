...
<head>
    ...
    <title>Corporate Sponsors - Team CURE</title>
...
<body class="bg-white text-black">
    ...
    <!-- Corporate Sponsors Content Section -->
    <section class="min-h-screen py-20 bg-white border-t-4 border-black relative pt-32">
        ...
        <div class="w-full max-w-7xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
            <h1 class="text-4xl md:text-5xl font-bold text-center mb-12 text-black">
                Corporate Sponsors
            </h1>
            <div class="max-w-5xl mx-auto space-y-10">
                <div class="bg-white text-black rounded-lg shadow-2xl p-8 md:p-12 border-4 border-cure-pink flex flex-col md:flex-row items-center md:items-start gap-8">
                    <div class="flex-shrink-0">
                        <div class="bg-white border-2 border-black rounded-lg p-3">
                            <img src="assets/sru-fcu-logo.png" alt="SRU Federal Credit Union logo" class="h-20 w-auto object-contain">
                        </div>
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold mb-3">SRU Federal Credit Union</h2>
                        <p class="text-lg md:text-xl leading-relaxed">
                            placeholder summary about SRU Federal Credit Union and their partnership with Team CURE. This section will highlight their support, shared values, and impact on the community.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white text-black rounded-lg shadow-2xl p-8 md:p-12 border-4 border-cure-pink flex flex-col md:flex-row items-center md:items-start gap-8">
                    <div class="flex-shrink-0">
                        <div class="bg-white border-2 border-black rounded-lg p-3">
                            <img src="assets/sponsors/a-plus.png" alt="A Plus logo" class="h-20 w-auto object-contain">
                        </div>
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold mb-3">A Plus</h2>
                        <p class="text-lg md:text-xl leading-relaxed">
                            Proud corporate sponsor of Team CURE Foundation.
                        </p>
                    </div>
                </div>
            </div>
